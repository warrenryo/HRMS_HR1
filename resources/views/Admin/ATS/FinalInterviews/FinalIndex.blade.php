                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                                    ...
                                    <tr class="duration-300 {{\Carbon\Carbon::parse($applicant->date)->isToday() && \Carbon\Carbon::parse($applicant->time)->isSameHour(\Carbon\Carbon::now()) && $applicant->isDone == false ? 'bg-orange-200 dark:bg-orange-200 hover:bg-orange-300 dark:hover:bg-orange-300' : 'hover:bg-gray-100 dark:hover:bg-neutral-700 ' }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800  {{ \Carbon\Carbon::parse($applicant->time)->isSameHour(\Carbon\Carbon::now()) ? 'text-black' : 'dark:text-neutral-300 ' }}"> 
