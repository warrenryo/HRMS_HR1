                                ...
                                <div>
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:items-center sm:gap-x-5">
                                        ...
                                        <img id="avatarImage" class="-mt-8 relative z-10 inline-block size-24 mx-auto sm:mx-0 rounded-full ring-4 ring-white dark:ring-neutral-900"
                                            src="{{asset('profile/'.$employee->profile)}}" alt="Avatar">
                                    </div>
                                </div>
                                <!-- Card Section -->
                                <div class="mx-auto">
                                    ...
                                    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-900">
                                        ...
                                        <div class="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                                            ...
                                            <div class="sm:col-span-9">
                                                <input id="af-submit-application-email" value="{{$employee->email}}" readonly type="email" required name="email" placeholder="Email" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="sm:col-span-9">
                                                <div>
                                                    <input id="af-submit-application-email" value="{{\Carbon\Carbon::parse($employee->birthdate)->format('F j, Y') }}" readonly type="email" required name="email" placeholder="Email" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                                </div>
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="sm:col-span-9">
                                                <input id="af-submit-application-email" value="{{$employee->gender}}" readonly type="email" required name="email" placeholder="Email" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="sm:col-span-9">
                                                <input id="af-submit-application-email" value="{{$employee->civil_status}}" readonly type="email" required name="email" placeholder="Email" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="sm:col-span-9">
                                                <input  value="{{$employee->number}}" readonly name="phone" id="af-submit-application-phone" placeholder="Mobile Number" type="number" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            </div>
                                            <!-- End Col -->
                                        ...
                                        <div class="grid sm:grid-cols-12 gap-2 sm:gap-4 py-8 first:pt-0 last:pb-0 border-t first:border-transparent border-gray-200 dark:border-neutral-700 dark:first:border-transparent">
                                            ...
                                            <div class="sm:col-span-9">
                                                <input id="af-submit-application-linkedin-url" value="{{$employee->sss}}" readonly type="text" name="sss"  class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="sm:col-span-9">
                                                <input id="af-submit-application-twitter-url" name="tin" value="{{$employee->tin}}" readonly  type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="sm:col-span-9">
                                                <input id="af-submit-application-github-url" value="{{$employee->philhealth}}" readonly  name="philhealth" type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="sm:col-span-9">
                                                <input id="af-submit-application-portfolio-url" value="{{$employee->pagibig}}" readonly name="pagibig" type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600">
                                            </div>
                                            <!-- End Col -->
