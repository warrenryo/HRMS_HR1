                    ...
                    <div class="">
                        ...
                        <div class="border dark:border-hotel_black-extra_light  rounded-lg">
                            <div class="p-4">
                                ...
                                <p class="font-bold text-gray-700 uppercase dark:text-gray-300 ">{{$applicant->applicantFinal->first_name}} {{$applicant->applicantFinal->last_name}}</p>
                            </div>
                            <hr class="dark:border-hotel_black-extra_light" />
                            <div class="p-4">
                                <h1 class="text-sm text-gray-500 mb-1">Email</h1>
                                <p class="font-bold text-gray-700 dark:text-gray-300 ">{{$applicant->applicantFinal->email}}</p>
                            </div>
                            <hr class="dark:border-hotel_black-extra_light" />
                            <div class="p-4">
                                <h1 class="text-sm text-gray-500 mb-1">City,State</h1>
                                <p class="font-bold text-gray-700 dark:text-gray-300 ">{{$applicant->applicantFinal->city_state}}</p>
                            </div>
                            <hr class="dark:border-hotel_black-extra_light" />
                            <div class="p-4">
                                <h1 class="text-sm text-gray-500 mb-1">Phone</h1>
                                <p class="font-bold text-gray-700 dark:text-gray-300 ">+63 {{$applicant->applicantFinal->phone}}</p>
                            </div>
                        </div>
                        <div class="pb-6 mt-4">
                            <h1 class="text-2xl font-bold text-gray-800  dark:text-white">
                        ...
                        <div class="border dark:border-hotel_black-extra_light  rounded-lg">
                            <div class="p-4">
                                ...
                                <p class="font-bold text-gray-700 dark:text-gray-300 ">{{$applicant->applicantFinal->prev_job_title}}</p>
                            </div>
                            <hr class="dark:border-hotel_black-extra_light" />
                            <div class="p-4">
                                <h1 class="text-sm text-gray-500 mb-1">Previous Company</h1>
                                <p class="font-bold text-gray-700 dark:text-gray-300 ">{{$applicant->applicantFinal->prev_company}}</p>
                            </div>
                        </div>
                        ...
                        <div class="border dark:border-hotel_black-extra_light  rounded-lg">
                            <div class="p-4">
                                ...
                                <p>{{$applicant->applicantFinal->AI_Prompt}}</p>
                            </div>
                        </div>
                        @php
                        $job = \App\Models\JobPosting\JobPosting::find($applicant->applicantFinal->job_id);
                        @endphp
                        @if($job->questions->count() > 0)
                        <div class="h-[60vh] my-10">
                            <h1 class="text-gray-500 font-bold pb-2">Your resume</h1>
                            <embed src="{{ asset('resumes/' . $applicant->applicantFinal->resume_path) }}" width="100%" height="100%" frameborder="0"></e>
                        </div>
                        @else
                    ...
                    <div class="min-w-full">
                        ...
                        <div class="border dark:border-hotel_black-extra_light rounded-lg box-border">
                            ...
                            <div class="my-4 px-6">
                                ...
                                $answer = $applicant->applicantFinal->applicantAnswer->firstWhere('employer_question_id', $question->id);
